      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td><div class="gc-cell gc-4"><span class="gc-score">0.4</span><span class="gc-sub">Infrastructure visible au fond</span></div></td>
            <td><div class="gc-cell gc-1"><span class="gc-score">0.1</span><span class="gc-sub">Bouees en surface en permanence</span></div></td>
            <td><div class="gc-cell gc-2"><span class="gc-score">0.2</span><span class="gc-sub">Plateforme concentree mais permanente</span></div></td>
            <td><div class="gc-cell gc-9 gc-best"><span class="gc-score">0.9</span><span class="gc-sub">Bouee temporaire, ancre invisible</span></div></td>
          </tr>
          <tr>
            ...
            <td><div class="gc-cell gc-3"><span class="gc-score">0.3</span><span class="gc-sub">Plongeurs pour biofouling + reparation cables</span></div></td>
            <td><div class="gc-cell gc-2"><span class="gc-score">0.2</span><span class="gc-sub">Plongeurs biofouling + entretien panneaux</span></div></td>
            <td><div class="gc-cell gc-3"><span class="gc-score">0.3</span><span class="gc-sub">Plongeurs + maintenance WiFi longue portee</span></div></td>
            <td><div class="gc-cell gc-8 gc-best"><span class="gc-score">0.8</span><span class="gc-sub">Nettoyage a terre, entretien fond espacé</span></div></td>
          </tr>
          <tr>
            ...
            <td><div class="gc-cell gc-1"><span class="gc-score">0.1</span><span class="gc-sub">Cout lineaire, extension couteuse par plongeur</span></div></td>
            <td><div class="gc-cell gc-4"><span class="gc-score">0.4</span><span class="gc-sub">Deployable mais entretien par unite</span></div></td>
            <td><div class="gc-cell gc-3"><span class="gc-score">0.3</span><span class="gc-sub">Cout par station eleve, surveillance accrue</span></div></td>
            <td><div class="gc-cell gc-7 gc-best"><span class="gc-score">0.7</span><span class="gc-sub">A terme, zero installation au fond</span></div></td>
          </tr>
        </tbody>
      </table>
    </div>
