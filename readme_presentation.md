...
The slow-descent approach draws from [TumblerBots (Romanello et al. 2024)](https://arxiv.org/abs/2410.23049), a drone-deployable tumbling sensor designed for minimally invasive benthic monitoring — the capsule descends at 0.8–2.5 m/s, detaches a sensing pod that sinks to the bottom, and recovers by inflating a silicone membrane via chemical reaction. No battery needed for recovery, ecologically safe materials. The free-deployment concept for coral restoration draws from [Ramsby et al. 2026](https://onlinelibrary.wiley.com/doi/10.1111/rec.70206) (Restoration Ecology), who tested non-fixed coral recruitment devices dropped from the surface — devices drifted little, didn't damage the substrate on landing, and cemented themselves to the reef within months via encrusting organisms. Their retention rates (62–89%) suggest that free-deployed hardware can stay where it lands without mechanical anchoring.
